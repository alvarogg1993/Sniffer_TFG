  ...
  extends JFrame
{
  ...
  public Fcaptura()
  {
    ...
    this.RCountPacketHandler = new CountPacketHandler(this);
    FachadaDominio.getPcap().addPacketListener(this.RCountPacketHandler);
  ...
  private void initComponents()
  {
    ...
    this.jPanel1.add(this.jProgressBar1, 
      new AbsoluteConstraints(70, 30, 60, 
      20));
    
    this.jLabel1.setText("Ethernet");
    this.jPanel1.add(this.jLabel1, new AbsoluteConstraints(
      10, 30, -1, -1));
    
    this.jLabel2.setText("Arp");
    this.jPanel1.add(this.jLabel2, new AbsoluteConstraints(
      10, 60, -1, -1));
    
    this.jLabel3.setText("Ip");
    this.jPanel1.add(this.jLabel3, new AbsoluteConstraints(
      10, 90, -1, -1));
    
    this.jLabel4.setText("Icmp");
    this.jPanel1.add(this.jLabel4, new AbsoluteConstraints(
      10, 120, -1, -1));
    
    this.jLabel5.setText("Igmp");
    this.jPanel1.add(this.jLabel5, new AbsoluteConstraints(
      10, 150, -1, -1));
    
    this.jLabel6.setText("Tcp");
    this.jPanel1.add(this.jLabel6, new AbsoluteConstraints(
      10, 180, -1, -1));
    
    this.jLabel7.setText("Udp");
    this.jPanel1.add(this.jLabel7, new AbsoluteConstraints(
      10, 210, -1, -1));
    
    this.jPanel1.add(this.jProgressBar2, 
      new AbsoluteConstraints(70, 60, 60, 
      20));
    
    this.jPanel1.add(this.jProgressBar3, 
      new AbsoluteConstraints(70, 90, 60, 
      20));
    
    this.jPanel1.add(this.jProgressBar4, 
      new AbsoluteConstraints(70, 120, 60, 
      20));
    
    this.jPanel1.add(this.jProgressBar5, 
      new AbsoluteConstraints(70, 150, 60, 
      20));
    
    this.jPanel1.add(this.jProgressBar6, 
      new AbsoluteConstraints(70, 180, 60, 
      20));
    



    this.jPanel1.add(this.jProgressBar7, 
      new AbsoluteConstraints(70, 210, 60, 
      20));
    this.jPanel1.add(this.jLabel22, 
      new AbsoluteConstraints(185, 10, -1, 
      -1));
    this.jPanel1.add(this.jLabel8, new AbsoluteConstraints(
      150, 30, -1, -1));
    this.jPanel1.add(this.jLabel15, 
      new AbsoluteConstraints(200, 30, -1, 
      -1));
    this.jPanel1.add(this.jLabel20, 
      new AbsoluteConstraints(200, 180, -1, 
      -1));
    this.jPanel1.add(this.jLabel9, new AbsoluteConstraints(
      150, 60, -1, -1));
    this.jPanel1.add(this.jLabel16, 
      new AbsoluteConstraints(200, 60, -1, 
      -1));
    this.jPanel1.add(this.jLabel10, 
      new AbsoluteConstraints(150, 90, -1, 
      -1));
    this.jPanel1.add(this.jLabel10, 
      new AbsoluteConstraints(150, 90, -1, 
      -1));
    this.jPanel1.add(this.jLabel17, 
      new AbsoluteConstraints(200, 90, -1, 
      -1));
    this.jPanel1.add(this.jLabel11, 
      new AbsoluteConstraints(150, 120, -1, 
      -1));
    this.jPanel1.add(this.jLabel18, 
      new AbsoluteConstraints(200, 120, -1, 
      -1));
    this.jPanel1.add(this.jLabel12, 
      new AbsoluteConstraints(150, 150, -1, 
      -1));
    this.jPanel1.add(this.jLabel19, 
      new AbsoluteConstraints(200, 150, -1, 
      -1));
    this.jPanel1.add(this.jLabel13, 
      new AbsoluteConstraints(150, 180, -1, 
      -1));
    this.jPanel1.add(this.jLabel14, 
      new AbsoluteConstraints(150, 210, -1, 
      -1));
    this.jPanel1.add(this.jLabel21, 
      new AbsoluteConstraints(200, 210, -1, 
      -1));
    
    getContentPane().add(
      this.jPanel1, 
      new AbsoluteConstraints(0, 0, 230, 
      250));
    
    this.jPanel2.setLayout(new BorderLayout());
    
    this.jPanel2.setBorder(new TitledBorder("Packets"));
    ...
    this.jPanel2.add(this.jProgressBar8, "South");
    
    getContentPane().add(
      this.jPanel2, 
      new AbsoluteConstraints(238, 0, 460, 
      250));
    ...
    this.jButton1.setIcon(new ImageIcon(
      ...
      "stop.png"));
    this.jButton1.setText("STOP Capture");
    ...
    getContentPane().add(
      this.jButton1, 
      new AbsoluteConstraints(280, 260, -1, 
      -1));
    ...
    this.jButton2.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        Fcaptura.this.jButton2ActionPerformed(evt);
      }
    });
    getContentPane().add(
      this.jButton2, 
      new AbsoluteConstraints(640, 260, 50, 
      30));
  ...
  public void salir()
  {
    this.mediador.irFinCapture();
    this.mediador.deshabilitarBHelemento(0);
    this.mediador.deshabilitarBHelemento(1);
    this.mediador.habiliatarBHelemento(3);
    this.mediador.habiliatarBHelemento(4);
    this.mediador.deshabilitarComponenteBarraMenus(1, 0);
    this.mediador.deshabilitarComponenteBarraMenus(1, 1);
    this.mediador.deshabilitarComponenteBarraMenus(1, 3);
    this.mediador.deshabilitarComponenteBarraMenus(0, 0);
  ...
  {
    this.jTextArea1.append("RawPacket " + i + ":" + pakete + this.newline);
  }
  ...
  public void intervalo(int numpackets, int ethernet, int arp, int ip, int icmp, int igmp, int tcp, int udp)
  {
    this.jLabel22.setText("Packets");
    this.jLabelpk.setText("Num packets :" + String.valueOf(this.pktotales));
    
    this.jProgressBar8.setMaximum(this.PACKET_COUNT);
    this.jProgressBar8.setValue(this.pktotales);
    int p_udp;
    int p_ethernet;
    int p_arp;
    int p_ip;
