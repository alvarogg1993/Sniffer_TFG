...
/** 
 * Clase PreferenciasFromFile. 
 * 
 * @author Jose Manuel Saiz, Carlos Mardones
 * @author jmsaizg@gmail.com,  
 * @version 1.2 
*/
 public class PreferenciasFromFile
   extends JDialog
 {
   ...
   public PreferenciasFromFile()
   {
     ...
     this.title = "Inicio Captura desde fichero";
     tipo = true;
   ...
   public PreferenciasFromFile(boolean tipo, Mediador med)
   {
     ...
     if (tipo) {
       ...
       this.title = "Preferencias de Captura desde fichero";
     }
     this.mediador = med;
     initComponents();
     ((CBFiltroAyuda)this.jButton1).setEnabled(false);
   ...
   private void initComponents()
   {
     ...
     jPanel1.setBorder(
       BorderFactory.createTitledBorder("Captura desde fichero"));
     ...
     jCheckBox2.addItemListener(new ItemListener()
     {
       ...
       {
         PreferenciasFromFile.this.jCheckBox2ItemStateChanged(evt);
       }
     });
     ...
     jPanel7Layout.setVerticalGroup(jPanel7Layout.createParallelGroup(
       ...
       -1, 
       -2).add(
       (CBFiltroAyuda)this.jButton1)));
     
     GroupLayout jPanel6Layout = new GroupLayout(
       jPanel6);
     ...
     this.jButton7 = new CBAbrirFichero(this.mediador, "Abrir fichero de Capturas desde fichero...");
     ...
     jPanel1Layout.setHorizontalGroup(
       ...
       .addContainerGap()
       .add(jPanel1Layout.createParallelGroup(1, false)
       .add(jPanel1Layout.createSequentialGroup()
       .add(jLabel1)
       .addPreferredGap(0)
       .add(jTextField11)
       .addPreferredGap(0)
       .add((CBAbrirFichero)this.jButton7))
       .add(jPanel6, -2, -1, -2))
     ...
     jCheckBox3.addItemListener(new ItemListener()
     {
       public void itemStateChanged(ItemEvent evt)
       {
         PreferenciasFromFile.this.jCheckBox3ItemStateChanged(evt);
       }
     });
     ...
     jCheckBox4.addItemListener(new ItemListener()
     {
       public void itemStateChanged(ItemEvent evt)
       {
         PreferenciasFromFile.this.jCheckBox4ItemStateChanged(evt);
       }
     });
     ...
     jCheckBox5.addItemListener(new ItemListener()
     {
       public void itemStateChanged(ItemEvent evt)
       {
         PreferenciasFromFile.this.jCheckBox5ItemStateChanged(evt);
       }
     });
     ...
     jCheckBox6.addItemListener(new ItemListener()
     {
       public void itemStateChanged(ItemEvent evt)
       {
         PreferenciasFromFile.this.jCheckBox6ItemStateChanged(evt);
       }
     });
     ...
     jCheckBox7.addItemListener(new ItemListener()
     {
       public void itemStateChanged(ItemEvent evt)
       {
         PreferenciasFromFile.this.jCheckBox7ItemStateChanged(evt);
       }
     });
     ...
     jCheckBox10.addItemListener(new ItemListener()
     {
       public void itemStateChanged(ItemEvent evt)
       {
         PreferenciasFromFile.this.jCheckBox10ItemStateChanged(evt);
       }
     });
     ...
     jPanel5Layout
       ...
       32767)));
     if (tipo) {
       this.jButton3 = new CBAceptar(this.mediador, "AceptarInicioCapturaFromFile");
     } else {
     ...
     jButton4.addActionListener(new ActionListener()
     {
       ...
       {
         PreferenciasFromFile.this.jButton4ActionPerformed(evt);
       }
     });
     this.jButton5 = new CBGuardarFichero(this.mediador, "GuardarInicioCapturaXMLFromFile");
     
     this.jButton6 = new CBAbrirFichero(this.mediador, "AbrirFicheroXMLFromFile");
     ...
     jPanel2Layout
       ...
       1)
       .add(
       (CBGuardarFichero)this.jButton5)
       .add(
       (CBAceptar)this.jButton3)))
       .add(
       jPanel1, 
       0, 
       -1, 
